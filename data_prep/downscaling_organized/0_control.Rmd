...
Make 3 types of test datasets: 

* 1 Unknown areas (all months) i.e. test areas of all months
* 2 Unknown time step for known areas (test months), i.e. training areas from testing months
* 3 Unknown areas and unknown months, i.e. test areas from testing months 
...
# 9a run all algorithms FFS on 1000m 
