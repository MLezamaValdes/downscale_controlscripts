...
saveRDS(mmtab,"add_files/overall_minmaxvals_train_valid.Rds")
...
write.csv2(train, paste0(trainvalidpath, "train_LHS_150000_scaled.csv"))

write.csv2(test1, paste0(trainvalidpath, "validation_1_LHS_150000_scaled.csv"))
write.csv2(test2, paste0(trainvalidpath, "validation_2_LHS_150000_scaled.csv"))
write.csv2(test3, paste0(trainvalidpath, "validation_3_LHS_150000_scaled.csv"))
