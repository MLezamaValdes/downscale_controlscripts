...
# install.packages("/home/l/llezamav/R/lubridate_1.7.10.tar.gz", repos = NULL,
...
jnk = clusterEvalQ(cl, {library(raster);library(parallel); library(rgdal); library(solrad,lib.loc="/home/l/llezamav/R/"); 
  ...
  library(lubridate,lib.loc="/home/l/llezamav/R/")})
clusterExport(cl, list("ccpath","uniqueMODscenes", "slrad", "asrad", "iahsrespath", "lat", "lon", "sl", "as",
                       "make_hs_ia", "month", "year","template"))

parLapply(cl, seq(length(uniqueMODscenes)), function(i){
