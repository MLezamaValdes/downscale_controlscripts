...
extract_train_test <- function(y,m){
  ...
  # print(paste0("all ", all_splits))
  # print(paste0("split", not_split))
  # 
...
#     
#     aux_complete <- auxdf[complete.cases(auxdf),]
#     write.csv2(aux_complete, paste0(datpath, "extraction_result_new/auxdf_check_cmp_css_", ym, ".csv"), row.names=F)
